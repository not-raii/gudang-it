                    ...
                    <div class="card shadow mb-4 border-top-primary">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                ...
                                <form action="{{route('barang.keluar')}}" method="GET" class="d-sm-inline-block form-inline">
                                    @csrf
                                ...
                                <div class="mt-4">
                                    ...
                                    <a class="btn btn-success" href="{{ route('add.barang.keluar') }}">Tambah +</a>
                                </div>
                            </div>
                                ...
                                <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>@sortablelink('tgl_keluar', 'Tanggal')</th>
                                            <th>Jumlah</th>
                                            <th>Aksi</th>
                                        </tr>
                                    </thead>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    <form method="POST" action="{{ route('delete.barang.keluar', $row->id) }}">
                                                        @csrf
                                                        <input name="_method" type="hidden" value="DELETE">
                                                        <a href="{{ route('update.barang.keluar', $row->id) }}" class="btn btn-warning"><i class="fas fa-edit"></i></a>
